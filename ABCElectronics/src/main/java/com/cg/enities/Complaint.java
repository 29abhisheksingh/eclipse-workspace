...
public class Complaint
{
	...
	public Complaint(int complaintId, int prodctModelNumber, String complainName, String statusw, int engineerId,
	...
	public int getProdctModelNumber() {
		return prodctModelNumber;
	}

	public void setProdctModelNumber(int prodctModelNumber) {
		this.prodctModelNumber = prodctModelNumber;
	}
